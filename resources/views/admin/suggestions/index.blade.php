<x-layout.admin-layout title="إدارة الاقتراحات">
    <div class="container mx-auto px-4 py-2">
        ...
        <!-- Suggestions List -->
        <div class="rounded-2xl bg-white/90 shadow-sm border border-purple-50 mb-6">
            <div class="flex items-center justify-between px-4 py-3 border-b border-purple-50">
