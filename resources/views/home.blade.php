        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6" x-data="weeklySlider()">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-gray-500 px-2" x-text="`${currentSlide + 1} من ${totalSlides}`"></span>
                    <button @click="nextSlide()" class="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition-colors" :class="{ 'opacity-50 cursor-not-allowed': currentSlide === totalSlides - 1 }">
            ...
            <div class="flex justify-center">
                <div class="w-full max-w-sm">
                    ...
                    <div x-show="currentSlide === {{ $index }}" 
                         ...
                         class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col overflow-hidden relative group transition hover:shadow-md h-auto">
            ...
            <div class="flex justify-center mt-6 gap-2">
                ...
                <button @click="goToSlide({{ $index }})" 
                        ...
                        :class="currentSlide === {{ $index }} ? 'bg-purple-600' : 'bg-gray-300 hover:bg-gray-400'">
                </button>
                @endforeach
            </div>
        </div>
